...
function Barcode39 ($barcode, $width, $height, $quality, $format, $text)
{
    ...
    or die ("Cannot Initialize new GD image stream");
        ...
        if ($text != 0)
        {
                ...
                ImageString ($im, $FontNum, $CenterLoc, $height-$FontHeight-10, "$BarcodeFull", $Black);
        }
        else
        {
            $FontHeight=-2;
        ...
        for ($i=0; $i<strlen($BarcodeFull); $i++)
        {
                ...
                for ($n=0; $n < 9; $n++)
                {
                        ...
                        {
                                case '0':
                                        ImageFilledRectangle ($im, $CurrentBarX, 10, $CurrentBarX+$NarrowBar, $height-1-$FontHeight-10, $Color);
                                        $CurrentBarX += $NarrowBar;
                                        break;


                                case '1':
                                        ImageFilledRectangle ($im, $CurrentBarX, 10, $CurrentBarX+$WideBar, $height-1-$FontHeight-10, $Color);
                                        $CurrentBarX += $WideBar;
                                        break;
                        }
                }
                ...
                $Color = $White;
                ImageFilledRectangle ($im, $CurrentBarX, 10, $CurrentBarX+$QuietBar, $height-1-$FontHeight-10, $Color);
