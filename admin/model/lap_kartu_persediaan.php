<?php
	...
	$jml_masuk = isset($_POST['jml_masuk']) ? $_POST['jml_masuk'] : '';
	$jml_keluar = isset($_POST['jml_keluar']) ? $_POST['jml_keluar'] : '';
	
	$bln = substr($tglawal,3,2);
	...
	$e = " AND DATE_FORMAT(tgl_transaksi, '%Y-%m-%d') BETWEEN CAST('$tglawal' AS DATE) AND CAST('$tglakhir' AS DATE)";  
	$e2 = " AND DATE_FORMAT(tgl_transaksi, '%Y-%m-%d') < '$tglawal' "; 
