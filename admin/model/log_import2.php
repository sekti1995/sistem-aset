<?php
	...
	if($id!="" && $id!="undefined"){ 
	$clause = "SELECT distinct uuid_skpd as id_ren ,id_sumber_dana as id_sumber FROM log_import_copy a
	 WHERE a.uuid_skpd = '$id'";
	}else{
		$clause = "SELECT a.id_rencana,a.uuid_skpd AS id_sub,b.nm_sub2_unit AS uuid_skpd, a.nm_kegiatan,a.nm_barang,c.nama_satuan,a.jumlah_barang,a.jumlah_barang_isi,a.harga,a.create_date,a.hasil  FROM log_import_copy a
