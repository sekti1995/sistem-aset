<?php
	...
	if($tglawal!="" AND $tglakhir!="") $c = " AND DATE_FORMAT(tgl_transaksi, '%Y-%m-%d') BETWEEN CAST('$tglawal' AS DATE) AND CAST('$tglakhir' AS DATE) "; 
	else $c = "";
	...
	$result = array();
	$clause = "SELECT kode, tgl_transaksi AS tanggal, jml_in AS masuk, jml_out AS keluar, harga FROM kartu_stok 
