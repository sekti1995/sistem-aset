<?php
	...
	while($row = mysql_fetch_assoc($rs)){
		...
		// PERUBAHAN 28-08-2019 MENGHILANGKAN FILTER SUMBER DANA PADA PENGELUARAN
		$ni = mysql_num_rows(mysql_query("SELECT id_stok FROM kartu_stok WHERE uuid_skpd = '$row[uuid_skpd]' AND soft_delete = '0' AND kode != 'r' GROUP BY id_gudang"));
