...
error_reporting(E_ALL); ini_set('display_errors', 'off'); 
	...
	$clause = "SELECT kd_unit, kd_sub, kd_sub2, uuid_sub2_unit AS id, nm_sub2_unit AS text, 
	...
	while($row = mysql_fetch_assoc($rs)){
		...
		/* if($_SESSION['peran_id']!=MD5('1') AND $_SESSION['peran_id']!=MD5('7') AND $all=="" AND $c==1 ){ $row['selected'] = true; $c++; }
