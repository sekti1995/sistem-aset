...
//}
	...
	$offset = ($page-1)*$rows;
	$result = array();
	$clause = "SELECT * FROM opd WHERE  g = 1 ORDER BY CAST(c AS UNSIGNED), CAST(e AS UNSIGNED) ASC";
	...
	while($row = mysql_fetch_assoc($rs)){
		// mysql_query("INSERT INTO ref_sub_unit(kd_urusan, kd_bidang, kd_unit, kd_sub, nm_sub_unit) VALUES ('$row[kd_urusan]','$row[kd_bidang]','$row[c]','$row[e]','$row[f]')");
