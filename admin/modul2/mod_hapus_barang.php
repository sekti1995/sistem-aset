...
function destroyPenghapusan(){
	...
	if (rw1){
		...
		function onBeginEdit(rowIndex){
			...
			var gudang = $(editors[7].target);
			var sumber = $(editors[8].target);
			var fbar = $(editors[9].target);
			var fgud = $(editors[10].target);
			var fsum = $(editors[11].target);
