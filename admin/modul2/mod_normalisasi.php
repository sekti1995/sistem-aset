...
<th field="soft_delete" width="70" halign="center" align="right">UPDATE</th>
</tr>
</thead>
</table>
</div>
<div id="toolbar"> 
	<div  >
		...
		<tr>
		<td>Nama OPD : 
		<input class="easyui-combobox" style="width:200px;" id="id_sub" name="id_sub"  required="true"/>
		<script>
		$('#id_sub').combobox({
		...
		<?php } ?>
			 Barang : <input class="easyui-combobox" style="width:220px;" id="id_bar" name="id_bar" />
				<script>
				$('#id_bar').combobox({
