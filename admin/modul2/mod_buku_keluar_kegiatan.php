 ...
 <table id="dgfull"class="easyui-datagrid"
	url="./model/lap_buku_keluar_kegiatan.php" fit="true"
...
<th field="tgl_keluar" width="110" align="left" halign="center" rowspan="2" >TGL KELUAR</th>
<th field="nomor" width="110" align="left" halign="center" rowspan="2" >NOMOR</th>
<th field="jml_barang" width="110" align="left" halign="center" colspan="4" >JUMLAH BARANG</th>
<th field="untuk" width="110" align="left" halign="center" rowspan="2" >UNTUK</th>
<th field="tgl_serah" width="110" align="left" halign="center" rowspan="2" >TGL PENYERAHAN</th>
</tr>
<tr>
...
$(function(){
	$('#dgfull').datagrid({
		...
		onExpandRow: function(index,row){
			...
			ddv.datagrid({
				url:'./model/lap_buku_keluar_kegiatan_detail.php?id_masuk_detail='+row.id_masuk_detail,
				fitColumns:true,
				singleSelect:true,
				rownumbers:true,
				loadMsg:'',
