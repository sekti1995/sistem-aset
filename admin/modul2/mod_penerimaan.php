...
<td colspan="2">: <input class="easyui-datebox" type="text" name="tgl_penerimaan" id="tgl_penerimaan" data-options="formatter:myformatter,parser:myparser,required:true" validType="validDate" style="width:100px;"></td>
</tr>
<tr>
<td>No Dokumen</td>
...
<tr>
<td>Tgl Dokumen</td>
<td colspan="2">: <input class="easyui-datebox" type="text" name="tgl_dok_penerimaan" id="tgl_penerimaan" data-options="formatter:myformatter,parser:myparser,required:true" validType="validDate" style="width:100px;"></td>
</tr>
<tr>
<td>Gudang/Tempat</td>
