...
<div id="dlg" class="easyui-dialog" style="width:530px;height:500px;padding:10px 20px"
...
<form id="fm" method="post">
			...
			onSelect: function(rec){
				if(rec.id_role==1){
					...
					if(rec.id==2||rec.id==3){
						$('#id_sub_unit').combobox('readonly', true);
						$('#id_sub2_unit').combobox('readonly', true);
						$('#id_unit').combobox('reload','./model/cb_sub2_unit.php?id_role='+rec.id);
					}else{
	...
	<div class="fitem">
		...
		$('#id_unit').combobox({
			...
			onSelect: function(rec){
				...
				$('#id_sub_unit').combobox('clear');
				$('#id_sub2_unit').combobox('clear');
				if(id_akses==2||id_akses==3){
					$('#id_sub_unit').combobox('reload','./model/cb_sub2_unit.php');
	...
	<div class="fitem">
		...
		$('#id_sub_unit').combobox({
			...
			onSelect: function(rec){
				$('#id_sub2_unit').combobox('clear');
				$('#id_sub2_unit').combobox('reload','./model/cb_sub2_unit.php?id_role='+id_akses+'&peserta2='+rec.id);
			}
		});
		</script>
	</div>
