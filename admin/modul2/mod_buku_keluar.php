 ...
 <table id="dgfull"class="easyui-datagrid"
	url="./model/lap_buku_keluar.php" fit="true"
...
var ta; var id_sub; var bln; var id_sumber;
function doSearch(){
...
function CetakDaftar(){
	...
	$.post( "./print/buku_keluar.php", { 
		ta : ta, bln: bln, id_sumber: id_sumber, <?php if($_SESSION['level']!=md5('c')){ ?> id_sub: id_sub <?php } ?>
	})
	.done(function( data ) {
