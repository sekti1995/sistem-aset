 ...
 <table id="dgfull"class="easyui-datagrid"
	url="./model/rekap_persediaan_smstr.php" fit="true" showFooter="true"
...
<tr>
	<td>Nilai</td>
	<td>: <input class="easyui-textbox" style="width:50px;" id="nilai" name="nilai" /> </td>
</tr>
<tr>
<td>Nama Sub Unit</td>
<td>: 
...
<tr>
	<td>Semester</td>
	<td>: <input class="easyui-combobox" style="width:90px;" id="smstr" name="smstr" required="true"/>
	<script>
	$('#smstr').combobox({
		valueField:'id',
		textField:'text',
...
function CetakDaftar(){
	...
	<?php if($_SESSION['level']!=md5('c')){ ?>else if(id_sub==undefined || id_sub=='') $.messager.alert('Peringatan','Unit Kerja Belum dipilih !'); <?php } ?>
		...
		$.post( "./print/rekap_persediaan_smstr.php", { basket : basket.rows, bulan : smstrt, 
				<?php if($_SESSION['level']!=md5('c')){ ?> id_sub: id_sub, <?php } ?> })
		.done(function( data ) {
