 ...
 <table id="dgfull"class="easyui-datagrid"
	url="./model/lap_rekap_barang.php" fit="true" showFooter="true"
	toolbar="#toolbar" title="Laporan Rekapitulasi Barang"
	rownumbers="true" fitColumns="true" singleSelect="true">
<thead>
<tr>
<th field="nama" width="110" align="left" halign="center">NAMA BARANG</th>
...
<div class="ftitle">Pencarian Data Rekapitulasi Barang</div>
...
<script>
$('#id_sub').combobox({
    url:'./model/cb_sub2_unit.php?skpd',
    valueField:'id',
    textField:'text',
...
$(function(){
	$('#dgfull').datagrid({
		...
		onExpandRow: function(index,row){
			...
			ddv.datagrid({
				url:'./model/lap_rekap_barang_detail.php?idb='+row.id_barang+'&kd='+foo[0].kode+'&bln='+bln+'&smstr='+smstr+'&ta='+ta+'&id_sum='+id_sum,
				fitColumns:true,
				singleSelect:true,
				rownumbers:true,
				loadMsg:'',
...
function CetakDaftar(){
	var basket = $('#dgfull').datagrid('getData');
		...
		$.post( "./print/lap_rekap_barang.php", { basket : basket.rows, bulan : blnt, ta : ta, smstr: smstr, 
