...
$objPHPExcel->getActiveSheet()->getStyle('A9:M10')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
$objPHPExcel->getActiveSheet()->getStyle('A9:M10')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);	
...
$objPHPExcel->getActiveSheet()
			...
			->mergeCells('B9:C9')
            ->setCellValue('D9', "MASUK")
			->setCellValue('E9', "KELUAR")
			->setCellValue('F9', "SISA")
			->setCellValue('G9', "KETERANGAN");	
...
$objPHPExcel->getActiveSheet()->getStyle("D11:F$row")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
//$objPHPExcel->getActiveSheet()->getStyle("A11:J$row")->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
$objPHPExcel->getActiveSheet()->getStyle("D11:F$row")->getNumberFormat()->setFormatCode("#,##0.00");		

			
//tulis border
$row--;
$objPHPExcel->getActiveSheet()->getStyle("A9:G$row")->applyFromArray($BStyle);
