...
<th field="nomor" width="150" align="left" halign="center">Nomor Nota</th>
...
<td colspan="2" width="150">
	<label><input type="radio" name="jenis" value="sendiri"> Permintaan dari Bidang </label><br>
	<label><input type="radio" name="jenis" value="skpd"> Minta kepada SKPD </label>
</td>
<td colspan="3"><input class="easyui-textbox" type="text" name="txtuntuk" id="txtuntuk" data-options="required:true" style="width:300px;"></td>
<tr>
</tr>
<tr>
<td>Nomor Nota</td>
...
<td>Tanggal Nota</td>
<td colspan="2">: <input class="easyui-datebox" type="text" name="tanggal" id="tanggal" data-options="formatter:myformatter,parser:myparser,required:true" style="width:100px;"></td>
</tr>
</table>
</form></br>
...
<div class="ftitle">Pencarian Perintah</div>
	...
	$('input[type="radio"]').click(function(){
		if ($(this).is(':checked'))
		{
			if($(this).val()=='sendiri'){
				...
				$('#lblbid').hide();
				$('#lblskpd').show();
				$('#txtuntuk').textbox('setValue','Dinas Kesehatan');
