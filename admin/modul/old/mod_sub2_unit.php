...
<table id="dg"class="easyui-datagrid" style="width:820px;height:350px"
	url="./model/dd_opb.php"
	toolbar="#toolbar" pagination="true"
	rownumbers="true" fitColumns="true" singleSelect="true">
<thead>
<tr>
<th field="c" width="10">Kode OPD</th>
<th field="d" width="40">Nama OPD</th>
<th field="e" width="10" align="center">Kode UPT</th>
<th field="f" width="40">Nama UPT</th>
<th field="g" width="10" align="center">Kode Sub Unit</th>
<th field="h" width="40">Nama Sub Unit</th>
</tr>
</thead>
</table>
<div id="toolbar">
