 ...
 <table id="dgfull"class="easyui-datagrid"
	...
	toolbar="#toolbar" title="Laporan Rekapitulasi Jenis Barang OPD"
...
<div id="dls" class="easyui-dialog" <?php if($_SESSION["jenis"] == "UPB"){ ?> 
	...
	<?php }?>
closed="true" buttons="#dls-buttons" title="Pencarian Data Rekapitulasi Jenis Barang OPD">
<div class="ftitle">Pencarian Data Rekapitulasi Jenis Barang OPD</div>
