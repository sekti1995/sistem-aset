 ...
 <table id="dgfull"class="easyui-datagrid"
	url="./model/lap_bulan.php" fit="true" showFooter="true"
...
<th width="130" align="center" colspan="2">SISA PERIODE LALU</th>
<th width="130" align="center" colspan="2">PENGADAAN PERIODE INI</th>
<th width="130" align="center" colspan="2">JML PERIODE INI</th>
<th width="130" align="center" colspan="2">PEMAKAIAN PERIODE INI</th>
<th width="130" align="center" colspan="2">SISA PERIODE INI</th>
</tr>
<tr>
...
function CetakDaftar(){
	...
	<?php if($_SESSION['level']!=md5('c')){ ?>else if(id_sub==undefined || id_sub=='') $.messager.alert('Peringatan','Unit Kerja Belum dipilih !'); <?php } ?>
		...
		$.post( "./print/lap_bulan.php", { basket : basket.rows, tglawal : tglawal, tglakhir : tglakhir, id_sum : id_sum, ta:ta,
				<?php if($_SESSION['level']!=md5('c')){ ?> id_sub: id_sub, <?php } ?> })
		.done(function( data ) {
