   ...
   <table id="basket" fitColumns="true" rownumbers="true"  style="width1:150px;height:260px;" toolbar="#tb" title="Data Barang">
	   <thead>
		   <tr>
			   ...
			   <th field="tgl_akhir" width=80 align="left" halign="center" editor="textbox" hidden >tgl_akhir</th>
		</tr>
		</thead>
	</table>	
</div>
...
<div id="dlg-buttons">
<a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="saveKeluar()" style="width:100px" id="btnsave">Save</a>
<a href="javascript:void(0)" class="easyui-linkbutton c6" style="width:100px;display:none" id="loadingsave">Menyimpan...</a>
		...
		if(rw1.jenis=='s' && rw1.status=='2'){
			...
			if (r){
				$.ajax({
					...
					data: { id_hapus: rw1.id, tanggal:rw1.tanggal },
        ...
        function endEditing(){
			...
			if ($('#basket').datagrid('validateRow', editIndex)){
				...
				.done(function( data ) {
					...
					if(parseFloat(saldo)>=parseFloat(jml) || parseFloat(saldo)<=parseFloat(jml)){
