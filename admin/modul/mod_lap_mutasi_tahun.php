 ...
 <table id="dgfull"class="easyui-datagrid"
	url="./model/lap_mutasi_tahun.php" fit="true" showFooter="true"
	toolbar="#toolbar" title="Laporan Tahunan Mutasi Barang Persediaan"
...
function CetakDaftar(){
	...
	$.post( "./print/lap_mutasi_tahun.php", { basket : basket.rows, ta:ta, 
			<?php if($_SESSION['level']!=md5('c')){ ?>  id_sub: id_sub <?php } ?> })
	.done(function( data ) {
