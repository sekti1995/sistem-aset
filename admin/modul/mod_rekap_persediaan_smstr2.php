 ...
 <table id="dgfull"class="easyui-datagrid"
	url="./model/rekap_persediaan_smstr2.php" fit="true" showFooter="true"
...
<th width="130" align="center" colspan="2">SISA SMT LALU</th>
<th width="130" align="center" colspan="2">PENGADAAN SMT INI</th>
<th width="130" align="center" colspan="2">JML SMT INI</th>
<th width="130" align="center" colspan="2">PEMAKAIAN SMT INI</th>
<th width="130" align="center" colspan="2">SISA SMT INI</th>
</tr>
<tr>
...
<div style="float: right; margin-right: 5px;">
	<a href="#" class="easyui-linkbutton" plain="true" iconCls="icon-search" onclick="cari()">Pencarian</a>
</div>
</div>
...
<?php } ?>
	...
	<div class="fitem">
		...
		<input class="easyui-combobox" style="width:90px;" id="smstr" name="smstr" required="true"/>
		<script>
		$('#smstr').combobox({
			valueField:'id',
			textField:'text',
			data: [{"id":1,"text":"Semester 1"},{"id":2,"text":"Semester 2"}]
		});
		</script>
	</div>
	<div class="fitem">
...
var ta; var id_sub; var smstr; var smstrt; var id_sum;
function cari(){
	$('#dls').dialog('open');
	$('#id_unit').combobox('clear');
	$('#id_sub_unit').combobox('clear');
...
function CetakDaftar(){
	...
	<?php if($_SESSION['level']!=md5('c')){ ?>else if(id_sub==undefined || id_sub=='') $.messager.alert('Peringatan','Unit Kerja Belum dipilih !'); <?php } ?>
		...
		$.post( "./print/rekap_persediaan_smstr2.php", { basket : basket.rows, bulan : smstrt, sd : sd, 
				<?php if($_SESSION['level']!=md5('c')){ ?> id_sub: id_sub, <?php } ?> })
		.done(function( data ) {
