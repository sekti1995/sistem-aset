...
var conf = {
            options:{
                fitColumns:true,
				columns:[[
                    {field:'kode_skpd',title:'Kode SKPD',width:30, align:'left', halign:'center'},
                    {field:'nama_skpd',title:'Nama SKPD',width:120, align:'left', halign:'center'},
                    ...
                    {field:'sisa',title:'Saldo Akhir',width:50, align:'right', halign:'center'}
                ]],
...
function CetakDaftar(){
	...
	$.post( "./print/lap_rekap_skpd.php", { basket : basket.rows, ta : ta, tglawal: tglawal, tglakhir: tglakhir
			})
	.done(function( data ) {
