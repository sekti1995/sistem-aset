 ...
 <table id="dgfull"class="easyui-datagrid"
	url="./model/rekap_persediaan_tahun2.php" fit="true" showFooter="true"
...
function CetakDaftar(){
	...
	<?php if($_SESSION['level']!=md5('c')){ ?>if(id_sub==undefined || id_sub=='') $.messager.alert('Peringatan','Unit Kerja Belum dipilih !'); <?php } ?>
	if(ta==undefined || ta=='') $.messager.alert('Peringatan','Tahun Belum dipilih !');
	else{
		$.loader.open($dataLoader);
		$.post( "./print/rekap_persediaan_tahun.php", { basket : basket.rows, ta:ta, sd : sd, 
				<?php if($_SESSION['level']!=md5('c')){ ?> id_sub: id_sub, <?php } ?> })
		.done(function( data ) {
