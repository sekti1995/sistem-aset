...
var thn; var id_sub; var bln; var id_bar; var id_sumber;  var sumber;
function doSearch(){
...
function CetakDaftar(){
	...
	$.post( "./print/kartu_barang.php", { 
		id_bar: id_bar, thn : thn, bln: bln, id_sumber : id_sumber, sumber: sumber, <?php if($_SESSION['level']!=md5('c')){ ?> id_sub: id_sub <?php } ?> })
	.done(function( data ) {
