...
<tr>
<th field="jml_admin" width="100" align="center" data-options="editor: {type:'textbox', options:{ readonly:'true'}}">Jumlah</th>
<th field="sat_admin" width="100" align="center" halign="center" data-options="editor: {type:'textbox', options:{ readonly:'true'}}">Satuan</th>
<!--<th field="hrgsat_admin" width="45" align="right" halign="center" data-options="editor: {type:'textbox', options:{ readonly:'true'}}">Satuan</th>
<th field="hrgtot_admin" width="45" align="right" halign="center" data-options="editor: {type:'textbox', options:{ readonly:'true'}}">Jumlah</th>-->
<th field="jml_so" width="100" align="center" data-options="editor: {type:'textbox', options:{ required:'true'}}">Jumlah</th>
<th field="sat_so" width="100" align="center" halign="center" data-options="editor: {type:'textbox', options:{ readonly:'true'}}">Satuan</th>
...
function saveSO(){
	...
	function endEditing(){
		...
		if ($('#dgfull').datagrid('validateRow', editIndex)){
			...
			var harga = $(ed[5].target).val();
			
			var sama = "";
			var dgfull = $('#dgfull').datagrid('getData');
			$.each(dgfull.rows, function(i,lab){
				if(lab['id_bar']==barang && lab['id_gud']==gudang && lab['id_sum']==sumber && harga==lab['hrgsat_admin'] && i!=editIndex) sama = 'ya';
			});
