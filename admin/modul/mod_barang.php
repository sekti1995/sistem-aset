...
<th field="jumlah_terkecil" width="200" align="left"  halign="center">Jml Terkecil</th>
<th field="txt_satuan_terkecil" width="200" align="left"  halign="center">Satuan Terkecil</th>
</tr>
</thead>
</table>
<div id="toolbar">
...
<div id="dlg" class="easyui-dialog" style="width:700px;height:460px;padding:10px 20px"
...
<tr>
<td>Jumlah Terkecil</td>
<td>: <input class="easyui-textbox" type="number" name="jumlah_terkecil"  style="width:100px;" ></input></td>
</tr>
<tr>
<td>Satuan Terkecil</td>
<td>: <input class="easyui-combobox" type="text" name="satuan_terkecil" id="satuan_terkecil"  style="width:100px;" ></input>
<script>
$('#satuan_terkecil').combobox({
    url:'./model/cb_satuan_barang.php',
    valueField:'id',
    textField:'text',
    filter: function(q, row){
