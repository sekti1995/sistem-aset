<div id="hpanel" class="easyui-panel" title="Daftar Tempat Penyimpanan"
    ...
    <table id="dg" class="easyui-datagrid" style="width:730px;height:350px" url="./model/dd_gudang.php"
    ...
    <div id="toolbar">
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="newGudang()">New
            Tempat</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true"
            onclick="editGudang()">Edit Tempat</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true"
            onclick="destroyGudang()">Remove Tempat</a>
        ...
        <form id="fm" method="post">
            <table cellpadding="5">
                <tr>
                    ...
                    <td>:
                        <input class="easyui-combobox" style="width:250px;" id="id_sub2_unit" name="id_sub2_unit"
                            <?php if ($peran != md5('1')) echo 'readonly'; ?> required="true" />
                        <script>
                ...
                <tr>
                    <td>Nama Tempat</td>
                    <td>: <input class="easyui-textbox" type="text" name="nama_gudang" id="nama_gudang"
                            data-options="required:true" size="25"></input></td>
                </tr>
                <tr>
                    <td>Lokasi</td>
                    <td>: <input class="easyui-textbox" type="text" name="lokasi" id="lokasi"
                            data-options="required:true" size="25"></input></td>
                </tr>
            </table>
    ...
    <div id="dlg-buttons">
        <a href="javascript:void(0)" class="easyui-linkbutton c6" iconCls="icon-ok" onclick="saveGudang()"
