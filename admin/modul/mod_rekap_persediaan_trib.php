 ...
 <table id="dgfull"class="easyui-datagrid"
	url="./model/rekap_persediaan_trib.php" fit="true" showFooter="true"
...
<th width="130" align="center" colspan="2">SISA TRIB LALU</th>
<th width="130" align="center" colspan="2">PENGADAAN TRIB INI</th>
<th width="130" align="center" colspan="2">JML TRIB INI</th>
<th width="130" align="center" colspan="2">PEMAKAIAN TRIB INI</th>
<th width="130" align="center" colspan="2">SISA TRIB INI</th>
</tr>
<tr>
...
<div id="dls" class="easyui-dialog" style="width:500px;height:auto;padding:10px 20px"
...
<tr>
	<td>Trib</td>
	<td>: <input class="easyui-combobox" style="width:90px;" id="trib" name="trib" required="true"/>
	<script>
	$('#trib').combobox({
		valueField:'id',
		textField:'text',
		data: [{"id":1,"text":"Trib 1"},{"id":2,"text":"Trib 2"},{"id":3,"text":"Trib 3"},{"id":4,"text":"Trib 4"}]
	});
	</script></td>
</tr>
<tr>
...
var ta; var id_sub; var trib; var tribt; var id_sum;
function pencarian(){
	$('#dls').dialog('open');
	<?php 
...
function doSearch(){
	trib = $('#trib').combobox('getValue');
	tribt = $('#trib').combobox('getText');
...
function CetakDaftar(){
	...
	if(trib==undefined || trib=='') $.messager.alert('Peringatan','Semester Belum dipilih !');
	<?php if($_SESSION['level']!=md5('c')){ ?>else if(id_sub==undefined || id_sub=='') $.messager.alert('Peringatan','Unit Kerja Belum dipilih !'); <?php } ?>
		...
		$.post( "./print/rekap_persediaan_trib.php", { basket : basket.rows, bulan : tribt, sd:sd,
				<?php if($_SESSION['level']!=md5('c')){ ?> id_sub: id_sub, <?php } ?> })
		.done(function( data ) {
