...
$objPHPExcel->getActiveSheet()
			...
			->mergeCells('E6:E7')
			->setCellValue('F6', "SALDO AWAL")
			->mergeCells('F6:G6')
			->setCellValue('F7', "JML")
			->setCellValue('G7', "JML HARGA")
			->setCellValue('H6', "PENGADAAN")
			->mergeCells('H6:I6')
			->setCellValue('H7', "JML")
			...
			->setCellValue('L6', "PEMAKAIAN")
			->mergeCells('L6:M6')
			->setCellValue('L7', "JML")
			->setCellValue('M7', "JML HARGA")
			->setCellValue('N6', "SALDO AKHIR")
			->mergeCells('N6:O6')
			->setCellValue('N7', "JML")
...
$objPHPExcel->getActiveSheet()
            ->setCellValue("M$row", "Karanganyar, $date");
$row++;
$objPHPExcel->getActiveSheet()
            ->setCellValue("C$row", "Kepala ".$skpd[nm_sub2_unit])
            ->setCellValue("M$row", "Pengurus Barang");
$row+=3;
$objPHPExcel->getActiveSheet()
            ->setCellValue("C$row", "$kepala")
            ->setCellValue("M$row", "$pengurus");
$row++;
$objPHPExcel->getActiveSheet()
            ->setCellValue("C$row", "NIP $nipk")
            ->setCellValue("M$row", "NIP $nipp");
