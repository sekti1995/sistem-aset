...
$objPHPExcel->getActiveSheet()
            ...
            ->setCellValue('D5', "SALDO AWAL")	
            ->setCellValue('E5', "PENGADAAN")	
            ->setCellValue('F5', "PENGELUARAN")	
            ->setCellValue('G5', "NILAI PERSEDIAAN");	
...
foreach($basket AS $d){
	...
	$masuk = preg_replace("/[^0-9]/","", $d['masuk']);
	$keluar = preg_replace("/[^0-9]/","", $d['keluar']);
	...
	$objPHPExcel->getActiveSheet()
            ...
            ->setCellValue('E'.$row, "$masuk")
            ->setCellValue('F'.$row, "$keluar")
            ->setCellValue('G'.$row, "$nilai");
...
$objPHPExcel->getActiveSheet()->getStyle("D7:G$row")->getNumberFormat()->setFormatCode("#,##0.00");			
//tulis border
//$row--;
$objPHPExcel->getActiveSheet()->getStyle("A5:G$row")->applyFromArray($BStyle);
$objPHPExcel->getActiveSheet()->getStyle("A6:G6")->applyFromArray($BTStyle);
