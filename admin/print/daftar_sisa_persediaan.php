...
$objPHPExcel->getActiveSheet()->getStyle('E7:F7')->getAlignment()->setWrapText(true);
...
$objPHPExcel->getActiveSheet()
            ...
            ->setCellValue('C4', ": $tglawal s/d $tglakhir")
            ->setCellValue('A5', 'Sumber Dana')
            ->setCellValue('C5', ": $sumber");
$objPHPExcel->getActiveSheet()
            ->setCellValue('A7', 'No')
			->setCellValue('B7', "Nama Barang")
			->mergeCells('B7:C7')
			->setCellValue('D7', "Satuan")
			->setCellValue('E7', "Harga\nSatuan")
			->setCellValue('F7', "Jumlah\nSatuan")
			->setCellValue('G7', "Harga Total");	
...
$objPHPExcel->getActiveSheet()->getStyle("E9:G$row")->getNumberFormat()->setFormatCode("#,##0.00");			
//tulis border
//$row--;
$objPHPExcel->getActiveSheet()->getStyle("A7:G$row")->applyFromArray($BStyle);
$objPHPExcel->getActiveSheet()->getStyle("A8:G8")->applyFromArray($BTStyle);
