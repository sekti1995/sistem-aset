...
$objPHPExcel->getActiveSheet()
			...
			->mergeCells('E6:E7')
			->setCellValue('F6', "SISA SMT LALU")
			->mergeCells('F6:G6')
			->setCellValue('F7', "JML")
			->setCellValue('G7', "JML HARGA")
			->setCellValue('H6', "PENGADAAN SMT INI")
			->mergeCells('H6:I6')
			->setCellValue('H7', "JML")
			->setCellValue('I7', "JML HARGA")
			->setCellValue('J6', "JML SMT INI")
			->mergeCells('J6:K6')
			->setCellValue('J7', "JML")
			->setCellValue('K7', "JML HARGA")
			->setCellValue('L6', "PEMAKAIAN SMT INI")
			->mergeCells('L6:M6')
			->setCellValue('L7', "JML")
			->setCellValue('M7', "JML HARGA")
			->setCellValue('N6', "SISA SMT INI")
			->mergeCells('N6:O6')
			->setCellValue('N7', "JML")
