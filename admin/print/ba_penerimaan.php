...
$templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor('../lampiran/Template BA Penerimaan.docx');
...
$templateProcessor->saveAs('../doc/BA Penerimaan '.$date.'.docx');

$response = array( 'success' => true, 'url' => './doc/BA Penerimaan '.$date.'.docx' );
